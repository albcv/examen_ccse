                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Exámenes Completados</span>
                      <span className="font-bold text-blue-600">{userData.examsCompleted}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Puntuación Promedio</span>
                      <span className="font-bold text-green-600">{userData.averageScore}%</span>
                    </div>
                  </div>
                </div>
